...
use crate::{context::{Context, CustomEventReader}, input_event::InputEvent, event_dispatcher::EventDispatcher};
...
pub(crate) fn process_events(
    ...
    query_world::<(
        ...
        if let Some(event) = custom_event_reader_cursor.0.iter(&cursor_moved_events).last() {
